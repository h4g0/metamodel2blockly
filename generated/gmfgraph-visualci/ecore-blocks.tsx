...
export const ECORE_BLOCKS = [
  ...
  {
  "type": "FigureGallery",
  "message0": "FigureGallery implementationBundle %1 figures %2 descriptors %3 borders %4 layouts %5",
  "args0": [
    {
      "type": "field_input",
  ...
  {
  "type": "Node",
  "message0": "Node resizeConstraint %1 affixedParentSide %2 contentPane %3",
  "args0": [
    {
      "type": "field_input",
  ...
  {
  "type": "Compartment",
  "message0": "Compartment collapsible %1 needsTitle %2 accessor %3",
  "args0": [
    {
      "type": "field_input",
      "name": "collapsible",
  ...
  {
  "type": "DiagramLabel",
  "message0": "DiagramLabel elementIcon %1 external %2 accessor %3 container %4",
  "args0": [
    {
      "type": "field_input",
      "name": "elementIcon",
  ...
  {
  "type": "Figure",
  "message0": "Figure foregroundColor %1 backgroundColor %2 maximumSize %3 minimumSize %4 preferredSize %5 font %6 insets %7 border %8 location %9 size %10 descriptor %11",
  "args0": [
    {
      "type": "input_value",
  ...
  {
  "type": "CustomClass",
  "message0": "CustomClass qualifiedClassName %1 attributes %2",
  "args0": [
    {
      "type": "field_input",
  ...
  {
  "type": "RealFigure",
  "message0": "RealFigure name %1 children %2",
  "args0": [
    {
      "type": "field_input",
      "name": "name",
  ...
  {
  "type": "AbstractFigure",
  "message0": "AbstractFigure",
  "args0": [],
  "colour": 125,
  "output": "AbstractFigure"
},
  {
  "type": "FigureDescriptor",
  "message0": "FigureDescriptor actualFigure %1 accessors %2",
  "args0": [
    {
      "type": "input_value",
      "name": "ACTUALFIGURE",
  ...
  {
  "type": "ChildAccess",
  "message0": "ChildAccess accessor %1 owner %2 figure %3",
  "args0": [
    {
      "type": "field_input",
      "name": "accessor",
...
export const ECORE_TOOLBOX = {
  ...
  contents: [
    ...
    {kind: "block" as const, type: "AbstractNode"},
    {kind: "block" as const, type: "RealFigure"},
    {kind: "block" as const, type: "AbstractFigure"},
    {kind: "block" as const, type: "FigureDescriptor"},
    {kind: "block" as const, type: "ChildAccess"},
    {kind: "block" as const, type: "BorderRef"},
    {kind: "block" as const, type: "LayoutRef"},
  ],
} as const;
