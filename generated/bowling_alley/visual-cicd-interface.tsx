...
env:
  ...
  // Pipeline run logs (still kept for logic, even if not currently rendered)
  ...
  const handleRun = async () => {
    ...
    if (isConnected && repository && apiKey) {
      ...
      const resultLines: string[] = ["Initializing pipeline..."]
